    ...
    public static object[][] lexData = {
      ...
      new object[] { string.Join("",
        ...
        "\n"), new[] {
          ...
          new Token(TokenKind.OpEquals, "==", new TokenPosition("", 1, 7)),
          new Token(TokenKind.OpNotEquals, "!=", new TokenPosition("", 1, 9)),
          new Token(TokenKind.OpLessThan, "<", new TokenPosition("", 1, 11)),
          new Token(TokenKind.OpGreaterThan, ">", new TokenPosition("", 1, 12)),
          new Token(TokenKind.OpLessThanOrEquals, "<=", new TokenPosition("", 1,13)),
          new Token(TokenKind.OpGreaterThanOrEquals, ">=", new TokenPosition("", 1, 15)),
